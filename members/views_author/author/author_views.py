...
def author_post_create_view(request):
    ...
    return render(
        request,
        'UserTemplates/UserAccount/Author/MyPostsAdd.html',
        context
    )
...
def author_post_view(request):
    ...
    return render(
        request,
        'UserTemplates/UserAccount/Author/MyPosts.html',
        context
    )
...
def author_post_detail_view(request, pk):
    ...
    return render(
        request,
        'UserTemplates/UserAccount/Author/MyPostsDetail.html',
        context
    )
...
def author_post_edit_view(request, pk):
    ...
    return render(
        request,
        'UserTemplates/UserAccount/Author/MyPostsEdit.html',
        context
    )
...
def author_post_delete_view(request, pk):
    ...
    return render(
        request,
        'UserTemplates/UserAccount/Author/MyPostsDelete.html',
        context
    )
