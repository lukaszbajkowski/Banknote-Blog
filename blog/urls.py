...
urlpatterns = [
    ...
    path('users/admin_panel/', views.users_manage_admin_panel_view, name='users_admin_panel'),
    ...
    path('social_app/admin_panel/', social_app_admin_panel_view, name='social_app_admin_panel'),
    ...
    path('social_token/admin_panel/', social_token_admin_panel_view, name='social_token_admin_panel'),
    ...
    path('social_account/admin_panel/', social_account_admin_panel_view, name='social_account_admin_panel'),
    ...
    path('email_address/admin_panel/', email_address_admin_panel_view, name='email_address_admin_panel'),
