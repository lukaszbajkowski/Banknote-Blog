...
urlpatterns = [
    ...
    path('newsletter/user/AdminPanel/', newsletter_user_manage_admin_panel_view, name='newsletter_user_admin_panel'),
    ...
    path('category/manage/AdminPanel/posts/<int:pk>', category_post_in_category_panel_detail_admin_panel_view,
    ...
    path('meetups_news/AdminPanel/', meetups_news_manage_admin_panel_view, name='meetups_news_admin_panel'),
    ...
    path('meetups_news/user/AdminPanel/', meetups_news_user_manage_admin_panel_view, name='meetups_news_user_admin_panel'),
    ...
    path('auction_opportunities/AdminPanel/', auction_opportunities_admin_panel_view, name='auction_opportunities_admin_panel'),
    ...
    path('auction_opportunities/user/AdminPanel/', auction_opportunities_user_manage_admin_panel_view, name='auction_opportunities_user_manage_admin_panel'),
    ...
    path('company_news/user/AdminPanel/', company_news_user_manage_admin_panel_view, name='company_news_user_manage_admin_panel'),
    ...
    path('replay_news/user/AdminPanel', replay_news_user_manage_admin_panel_view, name='replay_news_user_manage_admin_panel'),
    ...
    path('development_news/AdminPanel/', development_news_admin_panel_view, name='development_news_admin_panel'),
    ...
    path('development_news/user/AdminPanel', development_news_user_manage_admin_panel_view, name='development_news_user_manage_admin_panel'),
    ...
    path('skipped_posts/user/AdminPanel/', views.skipped_posts_user_admin_panel, name='skipped_posts_user_admin_panel'),
    ...
    path('users/', views.users_add_view, name='users_add'),
    path('users/AdminPanel/', views.users_manage_admin_panel_view, name='users_admin_panel'),
    path('users/detail/<int:pk>', views.users_detail_admin_panel_view, name='users_detail_admin_panel'),
    path('users/edit/<int:pk>', views.users_edit_main_page_admin_panel_view, name='users_edit_admin_panel'),
    path('users/edit/password/<int:pk>', views.users_edit_password_admin_panel_view, name='users_edit_password_admin_panel'),
    path('users/delete/<int:pk>', views.users_delete_admin_panel_view, name='users_delete_admin_panel'),
    ...
    path('social_app/detail/<int:pk>', social_app_detail_admin_panel_view, name='social_app_detail_admin_panel'),
    path('social_app/edit/<int:pk>', social_app_edit_admin_panel_view, name='social_app_edit_admin_panel'),
    path('social_app/delete/<int:pk>', social_app_delete_admin_panel_view, name='social_app_delete_admin_panel'),
    ...
    path('social_token/detail/<int:pk>', social_token_detail_admin_panel_view, name='social_token_detail_admin_panel'),
    path('social_token/edit/<int:pk>', social_token_edit_admin_panel_view, name='social_token_edit_admin_panel'),
    path('social_token/delete/<int:pk>', social_token_delete_admin_panel_view, name='social_token_delete_admin_panel'),

    # Widoki związane z kontami społecznościowymi
    path('social_account/', social_account_add_view,  name='social_account_add'),
    path('social_account/AdminPanel/', social_account_admin_panel_view, name='social_account_admin_panel'),
    path('social_account/detail/<int:pk>', social_account_detail_admin_panel_view, name='social_account_detail_admin_panel'),
    path('social_account/edit/<int:pk>', social_account_edit_admin_panel_view, name='social_account_edit_admin_panel'),
    path('social_account/delete/<int:pk>', social_account_delete_admin_panel_view, name='social_account_delete_admin_panel'),
    ...
    path('email_address/detail/<int:pk>', email_address_detail_admin_panel_view, name='email_address_detail_admin_panel'),
    path('email_address/edit/<int:pk>', email_address_edit_admin_panel_view, name='email_address_edit_admin_panel'),
    path('email_address/delete/<int:pk>', email_address_delete_admin_panel_view, name='email_address_delete_admin_panel'),
